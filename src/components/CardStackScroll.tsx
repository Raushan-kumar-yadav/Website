    ...
    return (
      <div className="mb-6 px-4">
        <motion.div
          ...
          className="w-full h-[60vh] rounded-2xl overflow-hidden bg-gray-200 relative"
        >
          <img
            src={src}
            alt="Project"
...
{/*           <div className="absolute inset-0 pointer-events-none"
               style={{
                 background: `radial-gradient(ellipse at center, transparent 10%, rgba(59, 130, 246, 0.3) 70%, rgba(59, 130, 246, 0.6) 100%)`,
  ...
  return (
    <div ref={container} className="h-screen flex items-center justify-center sticky top-4 sm:top-6 md:top-8 lg:top-10">
      ...
      >
        ...
        />
        {/* Inner glow overlay */}
         <div className="absolute inset-0 pointer-events-none  mt-3.5 ml-1.5 mb-1.5 mr-2 rounded-xl"
             style={{
               background: `radial-gradient(ellipse at center, transparent 60%, rgba(59, 130, 246, 0.3) 70%, rgba(59, 130, 246, 0.6) 100%)`,
               mixBlendMode: 'overlay'
             }}>
        </div> 
      </motion.div>
