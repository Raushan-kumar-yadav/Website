...
const FeatureSection = ({featureTitle,featureDesc,featureCards}:featureDetailsProps ) => {
    return (
        <section className="py-5 px-6 max-w-7xl mx-auto">
            <div className="left-1/8 mb-5 relative">
                ...
                <motion.p
                    variants={motionVarient.fadeInUp} initial='start' whileInView='end'
                    viewport={{ once: true }}
                    className="text-muted-foreground max-w-xl text-base md:text-lg relative  "
                >
                    {featureDesc}
                </motion.p>
