      ...
      <div className="text-center mb-16">
       ...
       before:backdrop-blur-sm"
        ...
        <div className="relative">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-110 h-50 bg-blue-500 blur-[200px] opacity-50 -z-10" style={{backgroundImage:`url(${Grid})`}}></div>
        </div>
      </div>
