...
const Overview = () => {
    ...
    return (
        <section className="py-20 px-6 max-w-7xl mx-auto">
           ...
           before:backdrop-blur-sm"
                ...
                <div className="relative">
                    ...
                    <div className="max-w-4xl mx-auto grid grid-cols-1 gap-5 mt-8 md:mt-20 xl:grid-cols[3fr,2.5fr] xl:items-center relative">
                        ...
                        <div className="mt-10">
                            <h2 className="uppercase inline-block text-sm uppercase px-4 py-2 
           bg-gradient-to-br from-blue/20 to-white/5
           backdrop-blur-lg backdrop-saturate-200
           border border-white/30
           rounded-full 
           ...
           before:absolute before:inset-0 
           before:bg-gradient-to-br before:from-white/20 before:to-transparent
           before:backdrop-blur-sm"> Join our community now</h2>

                            <div className="flex justify-center gap-2 mt-5 md:mt-5">
                                <Button className="">
                                    Explore Tools
                                </Button>
                            </div>
